const translations = {
  ...
  Malay: {
    ...
    dataEncryption: "Pengekodan Data",
    encryptionDesc: "Pengekodan hujung ke hujung didayakan",
    active: "Aktif",
    ...
    steps: "Langkah",
    exerciseCompleted: "Senaman Selesai",
    vitalSigns: "Tanda-tanda Vital",
    heartRateBpm: "Denyut Jantung (bpm)",
    weightKgInput: "Berat (kg)",
    nutrition: "Nutrisi",
    vegetableServings: "Porsi Sayur-sayuran",
    fruitServings: "Porsi Buah-buahan",
    sleep: "Tidur",
    hoursSlept: "Jumlah Jam Tidur",
    ...
    obesity: "Obesiti",
    dailySteps: "Langkah Harian Purata",
    enterDailySteps: "Masukkan langkah harian purata",
    ...
    average: "Sederhana",
    poor: "Lemah",
    fruitsVeggies: "Pengambilan Buah/Sayur Harian (sajian)",
    enterFruitsVeggies: "Masukkan bilangan sajian sehari",
    stressLevel: "Tahap Stres (1-10)",
    enterStressLevel: "Masukkan tahap stres (1-10)",
    ...
    errorAge: "Sila masukkan umur yang sah (18-120 tahun)",
