const translations = {
  ...
  Malay: {
    ...
    forgotPasswordSubtitle: "Masukkan Gmail anda untuk menerima kod pengesahan",
    ...
    poor: "Rendah",
    offlineMode: "Mod Luar Talian",
    offlineModeDescOn: "Gunakan model setempat untuk ramalan",
    offlineModeDescOff: "Gunakan API dalam talian untuk ramalan",
    offlineModeChanged: "Mod Luar Talian Berubah",
    offlineModeEnabled:
      "Mod luar talian diaktifkan. Ramalan akan menggunakan model setempat.",
    offlineModeDisabled:
      "Mod luar talian dinyahaktifkan. Ramalan akan menggunakan API dalam talian.",
    offlineModeError: "Gagal menukar mod luar talian.",
